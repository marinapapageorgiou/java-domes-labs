...
public class Huffman {
    ...
    private void encode() {
        ...
        /* enter your code! */
		//kataskeyh dentroy toy kvdika huffman
		while (PQ.size()>1) {
			Node kid1 = PQ.minItem();  //paidi
			int f1 = PQ.minKey();    //syxnothta

			Node kid2 = PQ.minItem();  
			int f2 = PQ.minKey(); 
   

			Node parent = new Node(' ', kid1, kid2); // o parent exei paidia ta kid1 kid2 
			PQ.insert(parent,f1+f2);    //      
